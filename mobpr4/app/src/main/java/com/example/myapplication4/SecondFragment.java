...
public class SecondFragment extends Fragment {
    ...
    public static class SecondFragmentRecyclerViewAdapter extends
        ...
        public class ViewHolder extends
            ...
            ViewHolder(View view){
                ...
                textView = view.findViewById(R.id.second_fragment_recycler_view_item_text);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 250; i++) {
            items.add(new Item("Mouse number " + i, getActivity().getDrawable(R.drawable.mouse)));
        }
        ...
        adapter.setOnClick(new SecondFragmentRecyclerViewAdapter.OnItemClicked() {
            ...
            public void onItemClick(int position) {
                ...
                TextView item_text_view = item.findViewById(R.id.second_fragment_recycler_view_item_text);
